...
public final class Constants {
    ...
    public static class CoralStation {
      public static final Pose2d CORAL_STATION_LEFT_1_BLUE =
          new Pose2d(1.65, 7.5, LEFT_CORAL_STATION_INTAKE_ANGLE)
              .transformBy(new Transform2d(0.0, Units.inchesToMeters(-6), Rotation2d.kZero));
  ...
  public static class CoralSubsystemConstants {
    ...
    public static final int CANRANGE_NEAR_CHANNEL = 0;
    public static final int CANRANGE_FAR_CHANNEL = 1;

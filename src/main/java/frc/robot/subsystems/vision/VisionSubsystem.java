...
import static frc.robot.Constants.VisionConstants.ANGULAR_STDDEV_BASELINE;
import static frc.robot.Constants.VisionConstants.APTAG_FIELD_LAYOUT;
import static frc.robot.Constants.VisionConstants.CAMERA_STDDEV_FACTORS;
import static frc.robot.Constants.VisionConstants.LINEAR_STDDEV_BASELINE;
import static frc.robot.Constants.VisionConstants.MAX_AMBIGUITY;
import static frc.robot.Constants.VisionConstants.MAX_Z_ERR;
        ...
        boolean rejectPose =
            observation.tagCount() == 0 // Must have at least one tag
                ...
                || Math.abs(observation.pose().getZ())
                    > MAX_Z_ERR // Must have realistic Z coordinate
